...
class AudioStreamerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PlayAudio = channel.stream_unary(
                ...
                response_deserializer=audio__pb2.PlayResult.FromString,
                )
...
def add_AudioStreamerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PlayAudio': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=audio__pb2.PlayResult.SerializeToString,
            ),
    }
...
class AudioStreamer(object):
    ...
    def PlayAudio(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/rero.AudioStreamer/PlayAudio',
            audio__pb2.Audio.SerializeToString,
            audio__pb2.PlayResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
